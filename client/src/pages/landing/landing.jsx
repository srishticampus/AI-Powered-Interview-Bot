...
import { Star, Search, ThumbsUp, Users, MoveRight, BadgeIcon } from "lucide-react";
      ...
      <div className="tw-container tw-mx-auto tw-px-16 tw-py-16">
        <div className="tw-grid tw-grid-cols-1 lg:tw-grid-cols-2 tw-gap-12 tw-items-center">
          ...
          <div className="tw-relative">
            ...
            <div className="tw-absolute tw-top-10 tw-left-80 tw-bg-white tw-p-2 tw-rounded-lg tw-shadow-lg">
              <div className="tw-flex tw-items-center tw-space-x-2">
